...
from console_io import SafeExitRequest, prompt_int
...
from quiz_session import QuizSessionRunner
from scoreboard import show_scores
...
class QuizGame:
    ...
    def __init__(
        ...
        *,
        ...
        self.session_runner = QuizSessionRunner(input_fn, output_fn, sample_fn=sample_fn)
