...
DELETE_QUIZ_TITLE = "삭제할 퀴즈 번호를 선택하세요."
DELETE_QUIZ_PROMPT = "삭제할 퀴즈 번호: "
QUIZ_ID_NOT_FOUND_MESSAGE = "해당 번호의 퀴즈가 없습니다. 다시 입력하세요."
...
PLAY_HISTORY_ENTRY_TITLE_TEMPLATE = "[플레이 기록 {entry_number}]"
